...
const DOCS = [
  ...
  { src: 'bundles/ux-bundle/README.md', slug: 'symfony-ux', title: 'Symfony UX bundle', group: 'Packages' },
  { src: 'bundles/sulu-bundle/README.md', slug: 'sulu-bundle', title: 'Sulu bundle', group: 'Sulu' },
