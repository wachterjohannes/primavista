...
- `bundles/sulu-bundle`: the Sulu bundle. PHP registers the translations, `assets/admin` holds the adapter and the registration a Sulu project imports into its admin build.
